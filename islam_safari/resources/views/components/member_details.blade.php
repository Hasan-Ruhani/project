<section class="w-full overflow-hidden dark:bg-gray-900">
    <div class="w-full mx-auto">
        <!-- User Cover IMAGE -->
        <img src="cover.png" alt="User Cover"
                class="w-full xl:h-[30rem] lg:h-[22rem] md:h-[16rem] sm:h-[13rem] xs:h-[9.5rem]" />
        ...
        <div
            ...
            <!-- FullName -->
            <h1 id="name" class="text-center text-gray-800 dark:text-white text-4xl font-serif"></h1>
            <!-- About -->
            <p class="w-full text-gray-700 dark:text-gray-400 text-md text-pretty sm:text-center xs:text-justify text-center">Lorem, ipsum dolor sit amet
