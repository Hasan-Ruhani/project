                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="team-item wow zoomIn" data-wow-delay="0.2s">
                            <img src="{{asset('assets/img/team-2.jpg')}}" class="img-fluid w-100" alt="">
                    ...
                    <div class="col-md-4">
                        <div class="team-item wow zoomIn" data-wow-delay="0.4s">
                            <img src="{{asset('assets/img/team-3.jpg')}}" class="img-fluid w-100" alt="">
                            <div class="team-content text-dark text-center py-3">
                                <div class="team-content-inner">
                    ...
                    <div class="col-md-4">
                        <div class="team-item wow zoomIn" data-wow-delay="0.6s">
                            <img src="{{asset('assets/img/team-4.jpg')}}" class="img-fluid w-100" alt="">
                            <div class="team-content text-dark text-center py-3">
                                <div class="team-content-inner">
